...
import stwf.patches.relics.BottledPlaceholderField;
...
import static stwf.SpireTogetherWithFriends.makeRelicOutlinePath;
import static stwf.SpireTogetherWithFriends.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = SpireTogetherWithFriends.makeID("BottledPlaceholderRelic");
