...
import stwf.actions.UncommonPowerAction;
import stwf.characters.TheDefault;

import static stwf.SpireTogetherWithFriends.makeCardPath;
...
public class DefaultUncommonPower extends AbstractDynamicCard {
    ...
    public static final String ID = SpireTogetherWithFriends.makeID(DefaultUncommonPower.class.getSimpleName());
